...
export const LOCATIONS = [
  {
    ...
    quiz:[
      { id:'0', mode:'quiz', fact:'Clean water, a comfortable resting area, and cooling or shade support cow comfort.', q:"Your herd needs relief on a warm afternoon. What belongs in the comfort plan?",
      ...
      { id:'1', mode:'quiz', q:"Milk has reached the bulk tank. Why turn on cooling right away?",
      ...
      { id:'2', mode:'quiz', q:"A farm has an anaerobic digester. What useful output can it capture from manure?",
  ...
  },
  {
    ...
    quiz:[
      { id:'0', mode:'quiz', q:"The delivery is on time. Which checks still matter before accepting its milk?",
      ...
      { id:'1', mode:'quiz', q:"You’ve switched the line from butter to cheese. Which process belongs to cheese?",
      ...
      { id:'2', mode:'quiz', q:"A pizzeria orders a large case of shredded mozzarella. Which delivery channel fits?",
  ...
  },
  {
    ...
    quiz:[
      { id:'0', mode:'quiz', q:"Milk, yogurt, and butter have arrived at the store. Where should this delivery go?",
      ...
      { id:'1', mode:'quiz', q:"You spot this seal on a dairy package. What does it tell you?",
      ...
      { id:'2', mode:'quiz', q:"Dinner service needs much more dairy than one family meal. Why order a larger format?",
